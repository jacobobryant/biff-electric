(ns com.biffweb.examples.electric.app
...
(defn notify-clients [{:keys [com.biffweb.examples.electric/chat-clients]} tx]
...
(defn ws-handler [{:keys [com.biffweb.examples.electric/chat-clients] :as ctx}]
  {:status 101
